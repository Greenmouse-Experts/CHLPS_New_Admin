...
export interface PageLoaderState<TData = unknown> {
  data?: TData;
  isLoading: boolean;
  isError: boolean;
  error?: unknown;
    ...
    return (
      <div className="min-h-[60vh] w-full flex flex-col items-center justify-center p-8 animate-in fade-in duration-700">
        <div className="relative flex items-center justify-center mb-8">
          ...
          <div className="absolute h-20 w-20 rounded-full border-4 border-primary/5 border-b-primary/40 animate-spin duration-[3000ms] [animation-direction:reverse]" />
